...
API_ID = int(environ.get('API_ID', '30613176'))
API_HASH = environ.get('API_HASH', '98e7896e5bb85842cd1a668958029861')
BOT_TOKEN = environ.get('BOT_TOKEN', "8945390214:AAHtr3Hnlfyvo5M1yLWaVBVvWlLZedpVei0")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6054478577').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004480995987').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1004474052000') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1006054478577')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003869137196').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sanoobssss:3KW24PlPU1rRR9Pw@cluster0.ypgjeoa.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Ik14BdOewjQzYjI1')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Sanoobshihab')
